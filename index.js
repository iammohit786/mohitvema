    ...
    writeStream.on("finish", () => {
      ...
      bot
        .sendVideo(chatId, `${title}-${chatId}.mp4`, {
          caption: `*Video downloaded:* ${title} "by" @vivhitbot 🏯`,
          thumb: thumbnailUrl,
...
bot.onText(/\/start/, (msg) => {
  ...
  bot.sendMessage(
    chatId,
    `Hey, I am vivhit made by @vivhitbot. Use the following commands to use me! 

/yt - Give any youtube link and @vivhit will download it for you.`
  );
});
